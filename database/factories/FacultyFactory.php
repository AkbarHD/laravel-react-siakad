...
class FacultyFactory extends Factory
{
    ...
    {
        // ketika factory ini berhasil dibuat
        return $this->afterCreating(function($faculty){
            $departments = match($faculty->name) {
                ...
                // jika tidak ada yang sama maka kembalikan array kosong
                default => [],
            };

            foreach ($departments as $department) {
                // departemns() itu hasMany di model Faculty
                $faculty->departmens()->create([
